...
public class DBConnection {
 ...
 public static Connection getConnection() {
        if (dbConnect!=null) return dbConnect;//si connection est nulle, retourne la connection
        PropertyResourceBundle properties = 
                (PropertyResourceBundle) PropertyResourceBundle.getBundle("resources.application");//ressources.application ?
